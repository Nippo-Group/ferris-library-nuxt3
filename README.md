...
Netlifyでステージング環境を用意しています。
クライアントへ更新内容を確認してもらう際などに利用してください。

[https://roaring-kheer-b99586.netlify.app/](https://roaring-kheer-b99586.netlify.app/)

Stagingブランチにプッシュするか、MicroCMSの記事を更新することで自動デプロイが走ります。
発火から約5分程度でビルドされます。
...
5. Pull Requestを作成
6. ステージングブランチにコミット
7. 問題なければメインブランチにコミット
8. 手動でビルド
9. 生成されたファイルを本番サーバーにアップロード
...
このプロジェクトは業務委託プロジェクトのため、ライセンス情報は契約に基づきます。
